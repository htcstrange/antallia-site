  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <div className="text-center mb-12">
        <h1 className="section-title">Notre <span className="glow-text">Équipe</span></h1>
        <p className="section-subtitle">Les personnes derrière Antallia qui font vivre le serveur au quotidien.</p>
      </div>
      ...
      <div className="card border-neon-purple/20 mt-12 text-center">
        <h3 className="text-lg font-bold text-white mb-2">Tu veux rejoindre l&apos;équipe ?</h3>
